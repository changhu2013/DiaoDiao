package mobi.dadoudou.diaodiao.mp3;
...
//		try {
//			// FileInputStream f = new FileInputStream("E://xt2009.lrc");
//			FileInputStream f = new FileInputStream("E://zshyn.lrc");
//			new LrcDecode().readLrc(f);
